...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      // custom font size
      '11px-15px': ['11px', { lineHeight: '15px' }],
      '12px-18px': ['12px', { lineHeight: '18px' }],
      '14px-19px': ['14px', { lineHeight: '19px' }],
      '14px-20px': ['14px', { lineHeight: '20px' }],
      '16px-18px': ['16px', { lineHeight: '18px' }],
      '16px-22px': ['16px', { lineHeight: '22px' }],
      '16px-28px': ['16px', { lineHeight: '28px' }],
      '18px-20px': ['18px', { lineHeight: '20px' }],
      '18px-24px': ['18px', { lineHeight: '24px' }],
      '18px-25px': ['18px', { lineHeight: '25px' }],
      '18px-26px': ['18px', { lineHeight: '26px' }],
      '18px-28px': ['18px', { lineHeight: '28px' }],
      '18px-30px': ['18px', { lineHeight: '30px' }],
      '20px-24px': ['20px', { lineHeight: '24px' }],
      '20px-28px': ['20px', { lineHeight: '28px' }],
      '22px-29px': ['22px', { lineHeight: '29px' }],
      '24px-26px': ['24px', { lineHeight: '26px' }],
      '24px-28px': ['24px', { lineHeight: '28px' }],
      '24px-30px': ['24px', { lineHeight: '30px' }],
      '24px-32px': ['24px', { lineHeight: '32px' }],
      '26px-58px': ['26px', { lineHeight: '58px' }],
      '28px-42px': ['28px', { lineHeight: '42px' }],
      '32px-43px': ['32px', { lineHeight: '43px' }],
      '40px-48px': ['40px', { lineHeight: '48px' }],
      '40px-58px': ['40px', { lineHeight: '58px' }],
      '48px-64px': ['48px', { lineHeight: '64px' }],
      '55px-75px': ['55px', { lineHeight: '75px' }],
    },
    fontWeight: {
      thin: '100',
      extralight: '200',
